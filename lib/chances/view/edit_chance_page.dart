...
class EditChance extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    setChanceDataOf(chance);
    print('path ${chancesController.pickedImage.value.path}');
    print('isNotEmtpy ${chancesController.pickedImage.value.path.isNotEmpty}');
    return Directionality(
      textDirection: TextDirection.rtl,
      child: Scaffold(
        appBar: AppBar(
          backgroundColor: kGreenColor,
          title: const Text('تعديل فرصة تطوعية'),
          centerTitle: true,
                      ...
                      () => chancesController.pickedImage.value.path.isEmpty
                          ...
                          : Row(
                              ...
                              children: [
                                Image.file(
                                  File(
                                      chancesController.pickedImage.value.path),
                                  width: 250.w,
                                ),
                              ],
                            ),
                ...
                : Column(
                    ...
                    children: [
                      ...
                      SimpleButton(
                        ...
                        label: 'حذف الفرصة',
                        onPress: () => chancesController.deleteChance(chance),
                      ),
                    ],
                  ),
          ),
  ...
  void setChanceDataOf(Chance chance) {
    _titleController.text = chance.title;
    _shortDescController.text = chance.shortDesc;
    _organizationController.text = chance.organization;
    _sitNumbersController.text = chance.sitsNo;
    _chanceURLController.text = chance.chanceURL;
    category.value = chance.category;
    requiredDegree.value = chance.requiredDegree;
    city.value = chance.city;
    startDate.value = chance.startDate;
    endDate.value = chance.endDate;
    chancesController.isTeamWork.value = chance.isTeamWork;
    chancesController.isUrgent.value = chance.isUrgent;
    chancesController.isOnline.value = chance.isOnline;
    chancesController.isSupportDisabled.value = chance.isSupportDisabled;
    chancesController.isNeedInterview.value = chance.isNeedInterview;

    chancesController.genderType.value = chance.gender == kMales
        ? Gender.males
